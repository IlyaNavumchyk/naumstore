...
(
    ...
    constraint users_users_name_check_length_more_than_0 check (length(user_name) > 0),
    surname           varchar(50),
    constraint users_surname_check_length_more_than_0 check (length(surname) > 0),
    patronymic        varchar(50),
    constraint users_patronymic_check_length_more_than_0 check (length(patronymic) > 0),
    birth             date,
